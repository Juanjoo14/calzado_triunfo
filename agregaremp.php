...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $query = "INSERT INTO empleados (Nombre, Apellido, DepartamentoID, FechaContrato) VALUES ('$nombre', '$apellido', '$departamentoId', '$fechaContrato')";
  ...
  <div class="container">
    ...
    <form method="post">
      ...
      <div class="custom-form-group">
        ...
        <input type="text" class="form-control rounded-4 border-2 custom-input " id="Apellido" name="Apellido" value="">
      </div>
      <div class="custom-form-group">
        <label for="DepartamentoId">DepartamentoID:</label>
        <input type="text" class="form-control rounded-4 border-2 custom-input " id="DepartamentoId" name="DepartamentoId" value="">
      </div>
      <div class="custom-form-group">
        <label for="FechaContrato">Fecha Contrato:</label>
        <input type="text" class="form-control rounded-4 border-2 custom-input " id="FechaContrato" name="FechaContrato" value="">
      </div>
